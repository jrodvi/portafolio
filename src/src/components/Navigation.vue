    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">
					<h1>
					<img id="brandLogo" style="height:3.25rem !important;" src="/src/assets/img/jrodriguez-logo.svg" alt="jrodriguez logo" />
					</h1>
				</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                    
                    <i class="fas fa-bars fa-2x ms-1"></i>
                </button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercasex ms-auto py-4 py-lg-0">
                        <li class="nav-item">
							<a class="nav-link" href="#home">
								<i class="fa-sharp fa-light fa-house"></i> Inicio
							</a>
						</li>
                        <li class="nav-item"><a class="nav-link" href="#portfolio"><i class="fa-sharp fa-light fa-folder-open"></i> Portafolio</a></li>
